-- =============================================================================
-- Dashboard Monitoring — FULL INSTALL (Consolidated Single File)
-- =============================================================================
...
-- Cakupan:
--   1.  users
--   2.  import_batches (termasuk dataset_id + kolom v2/v3)
--   3.  project_records (skema final — semua kolom v1/v2/v3)
--   4.  import_staging
--   5.  user_chart_preferences
--   6.  audit_logs
--   7.  column_definitions
--   8.  settings
--   9.  datasets (Dynamic Dataset System + sidebar cols)
--   10. saved_charts (Saved Dynamic Charts)
--   SEED: settings, admin user, column_definitions (all/closing/filter900/refinement)
-- =============================================================================
...
-- =============================================================================
-- 9. TABEL: datasets (Dynamic Dataset System + sidebar)
-- =============================================================================
...
-- =============================================================================
-- 10. TABEL: saved_charts (Saved Dynamic Charts)
-- =============================================================================
